...
BIG Help is based on the support app we use at "BIG Folio":http://www.www.aphotofolio.com and "NextProof":http://www.nextproof.com (we make stuff for photographers). It's worth noting that BIG Help is not a bug-tracking system like Lighthouse or Fog Bugz.

h2. Current status

BIG Help is currently live and in production at BIG Folio. You can "see it in action on our help page":http://help.aphotofolio.com.
